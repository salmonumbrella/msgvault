...
func (o OrganizationDuplicateSuggestion) Validate() error {
	return runtime.ConvertValidatorError(typesValidator.Struct(o))
}

type OrganizationDuplicateSuggestionsResponse struct {
	Suggestions []OrganizationDuplicateSuggestion `json:"suggestions,omitempty" validate:"required"`
}

func (o OrganizationDuplicateSuggestionsResponse) Validate() error {
	var errors runtime.ValidationErrors
	for i, item := range o.Suggestions {
		if v, ok := any(item).(runtime.Validator); ok {
			if err := v.Validate(); err != nil {
...
type ResolveOrganizationDuplicateSuggestionBody struct {
	...
	Status ResolveOrganizationDuplicateSuggestionBodyStatus `json:"status" validate:"required"`
}

func (r ResolveOrganizationDuplicateSuggestionBody) Validate() error {
	var errors runtime.ValidationErrors
