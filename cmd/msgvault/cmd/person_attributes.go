...
var personAttributesSetCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if personAttributeExpectedID > 0 {
...
func init() {
	...
	personAttributesSetCmd.Flags().Int64Var(&personAttributeExpectedID,
		"expected-value-id", 0,
		"Compare-and-swap: the value ID the write expects to supersede")
